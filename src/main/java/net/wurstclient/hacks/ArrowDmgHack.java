...
public final class ArrowDmgHack extends Hack implements StopUsingItemListener
{
	private enum DamageLevel
	{
		...
		DamageLevel(int packets, String displayName)
		{
	...
	private final EnumSetting<DamageLevel> damageLevel =
		new EnumSetting<>("Damage Level",
			"description.wurst.setting.arrowdmg.damage_level",
			DamageLevel.class, DamageLevel.MEDIUM);
	...
	public void onStopUsingItem()
	{
		...
		int packetCount = damageLevel.get().getPackets();
