...
public final class KeybindProcessor implements KeyPressListener
{
	...
	public void onKeyPress(KeyPressEvent event)
	{
		...
		// Handle double backspace for master toggle
		if(keyCode == GLFW.GLFW_KEY_BACKSPACE)
		{
			MasterToggleManager.getInstance().handleBackspacePress();
			return;
		}
		
		// If client is disabled, don't process any other keybinds
		if(MasterToggleManager.getInstance().isClientDisabled())
			return;
